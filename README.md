...
| [`src/`](src/README.md) | Contains the production implementation of Electrical Troubleshooter: command handling, domain rules, storage, reports, and local serving as applicable. |
| [`tests/`](tests/README.md) | Contains automated regression tests for Electrical Troubleshooter's public behavior and important safety constraints. |
...
- [`src/README.md`](src/README.md) — Contains the production implementation of Electrical Troubleshooter: command handling, domain rules, storage, reports, and local serving as applicable.
- [`tests/README.md`](tests/README.md) — Contains automated regression tests for Electrical Troubleshooter's public behavior and important safety constraints.
