...
- [x] Implement versioned JSON decision-tree schema, traversal, cycle detection, validation, import/export, and safety-content rules.
- [x] Add editable yes/no and multiple-choice nodes, explanations, visible warnings, back/reset, and safe termination states.
